...
public class StorageManager {
	...
	public static State saveFileByInputStream(InputStream is, String path,
		...
		BufferedInputStream bis = new BufferedInputStream(is, blog.com.blog.common.tools.ueditor.upload.StorageManager.BUFFER_SIZE);

		try {
			BufferedOutputStream bos = new BufferedOutputStream(
					new FileOutputStream(tmpFile), blog.com.blog.common.tools.ueditor.upload.StorageManager.BUFFER_SIZE);
